...
import org.example.vanphong.model.ProductType;
...
import org.example.vanphong.repository.ProductTypeRepository;
...
public class DataSeeder implements CommandLineRunner {
    ...
    @Autowired
    private org.example.vanphong.repository.RoleRepository roleRepository;

    @Autowired
    private org.example.vanphong.repository.StaffRepository staffRepository;

    @Autowired
    private org.example.vanphong.repository.UserRepository userRepository;
    ...
    private void seedAdmin() {
        ...
        if (userRepository.findByEmail("admin@ergoffice.com").isEmpty()) {
            org.example.vanphong.model.Role adminRole = roleRepository.findByRoleName("ADMINISTRATOR")
                .orElseGet(() -> {
                    org.example.vanphong.model.Role r = new org.example.vanphong.model.Role();
                    r.setRoleId(1);
                    r.setRoleName("ADMINISTRATOR");
                    return roleRepository.save(r);
                });

            org.example.vanphong.model.Staff admin = new org.example.vanphong.model.Staff();
    ...
    private void seedStaff() {
        ...
        org.example.vanphong.model.Role staffRole = roleRepository.findByRoleName("STAFF").orElse(null);
        if (staffRole == null) {
            staffRole = new org.example.vanphong.model.Role();
        ...
        if (userRepository.findByEmail("staff@ergoffice.com").orElse(null) == null) {
             ...
             org.example.vanphong.model.Staff staff = new org.example.vanphong.model.Staff();
             staff.setName("staff");
        ...
        if (userRepository.findByEmail("nhanvien@ergoffice.com").orElse(null) == null) {
             org.example.vanphong.model.Staff staff2 = new org.example.vanphong.model.Staff();
